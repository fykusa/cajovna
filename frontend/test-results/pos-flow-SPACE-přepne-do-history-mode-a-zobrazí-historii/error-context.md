...
- Name: pos-flow.spec.ts >> SPACE přepne do history mode a zobrazí historii
- Location: e2e\pos-flow.spec.ts:109:1
...
Locator: locator('[class*=historyPanel]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*=historyPanel]').first()
...
- banner:
  - button "Pokladna"
  - button "Dnešní přehled"
  - text: "Krok: category prodavacka"
  - button "Odhlásit"
- main:
  - text: Kategorie
  - list:
    - listitem: FF xxx sffg
    - listitem: Bílé
    - listitem: Zelené
    - listitem: Japonské
    - listitem: Zelené Čínské
    - listitem: Zelené Čínské Jasmínové
    - listitem: Vietnamské
    - listitem: Zelené Nepálské
    - listitem: Žluté
    - listitem: Čínský Oolong An Xi
    - listitem: Čínský Oolong Dan Cong
    - listitem: Čínský Oolong Wu Yi Shan
    - listitem: Taiwan Oolong
    - listitem: Ostatní
    - listitem: Čínské Červené
    - listitem: Japonské Červené
    - listitem: Černý Darjeeling Indie Nepál
    - listitem: Černý Assam
    - listitem: Čaje Kenya
    - listitem: Černý Taiwan
    - listitem: Černý Ceylon
    - listitem: Černý Gruzie
    - listitem: Čínský
    - listitem: Světlý Pchu-Er
    - listitem: Čínský Tmavý Pchu-Er
    - listitem: Yerba Mate
    - listitem: Všechny
    - listitem: Rooibos A Honeybush
    - listitem: Zelené Aromatické
    - listitem: Černé Aromaticke
    - listitem: Bylinky
  - text: Čaje
  - list:
    - listitem: Žádné čaje
  - complementary:
    - heading "Košík" [level=2]
    - paragraph: Košík je prázdný
```
