...
- Name: pos-flow.spec.ts >> kompletní prodej bez pytlíku
- Location: e2e\pos-flow.spec.ts:68:1
...
Locator: locator('text=Krok: category')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Krok: category')
...
- banner:
  ...
  - text: "Krok: bag_yn prodavacka"
  - button "Odhlásit"
- main:
  - paragraph: Chce pytlík?
  - list:
    - listitem: Ano
    - listitem: Ne
  - complementary:
